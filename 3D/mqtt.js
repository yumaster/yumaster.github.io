    ...
    return function() {
                ...
                (function() {
                    ...
                    c(v, i), v.prototype._setupStream = function() {
                        ...
                        function u() {
                            ...
                            var e = o.shift();
                            if (e) h("work :: packet pulled from queue"), t._handlePacket(e, c);
                            else {
                    ...
                    var n = e("once"),
                        ...
                        o = function(e, t, s) {
                            ...
                            return ! function(e) {
                                ...
                                }(e) ? l && !a && (e.on("end", h), e.on("close", h)) : (e.on("complete", p), e.on("abort", m), e.req ? _() : e.on("request", _)),
                                function(e) {
                        ...
                        switch (c("generate called"), t.cork && (t.cork(), a(m, t)), g && (g = !1, f()), c("generate: packet.cmd: %s", e.cmd), e.cmd) {
                            case "connect":
                                return function(e, t, i) {
                                    ...
                                    b += 1;
                                    if (("string" == typeof f || r.isBuffer(f)) && (f || a >= 4) && (f || u)) b += r.byteLength(f) + 2;
                                    else {
                    ...
                    e("inherits")(I, a), k.prototype.getBuffer = function() {
                        ...
                        function() {
                            ...
                            var i, o = this._writableState,
                                s = !1,
                                a = !o.objectMode && (i = e, c.isBuffer(i) || i instanceof u);
        ...
        46: [function(e, t, r) {
            ...
            t.exports = function e(t, r, o) {
                ...
                return function(e) {
                        return e.setHeader && "function" == typeof e.abort
                    }(t) ? (t.on("complete", l), t.on("abort", d), t.req ? g() : t.on("request", g)) : a && !t._writableState && (t.on("end", c), t.on("close", c)), t.on("end", h), t.on("finish", l), !1 !== r.error && t.on("error", p), t.on("close", d),
                    function() {
            ...
            o.prototype.parse = function(e, t, r) {
                ...
                if (!b[v] && (E || v && !m[v])) {
                    ...
                    for (T = 0; T < f.length; T++) {
                        var A; - 1 !== (A = _.indexOf(f[T])) && (-1 === C || A < C) && (C = A)
                ...
                if (k && (r.hostname = "", r.port = null, r.host && ("" === E[0] ? E[0] = r.host : E.unshift(r.host)), r.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === d[0] ? d[0] = e.host : d.unshift(e.host)), e.host = null), v = v && ("" === d[0] || "" === E[0])), w) r.host = e.host || "" === e.host ? e.host : r.host, r.hostname = e.hostname || "" === e.hostname ? e.hostname : r.hostname, r.search = e.search, r.query = e.query, E = d;
